...
class FirebaseAnalyticsProvider extends LogProvider {
  ...
  FirebaseAnalyticsProvider(this.firebaseOptions, this._ensembleAppId,
  ...
  Future<void> init() async {
    ...
    if (!isFirebaseAppInitialized) {
      ...
      if (firebaseOptions != null &&
        ...
        throw ConfigError(
            'The appId: ${firebaseOptions?.appId} specified in the Firebase configuration for ensembleapp with id: $_ensembleAppId is not the default firebase app. '
