...
class NativeInvokable extends ActionInvokable {
  ...
  Map<String, Function> methods() {
    ...
    methods.addAll({
      ...
      ActionType.showBottomModal.name: (inputs) => ScreenController()
          .executeAction(
              buildContext, ShowBottomModalAction.from(payload: inputs)),
      ActionType.dismissBottomModal.name: (inputs) => ScreenController()
          .executeAction(
              buildContext, DismissBottomModalAction.from(payload: inputs)),
      ActionType.showDialog.name: (inputs) => ScreenController().executeAction(
          buildContext, ShowDialogAction.from(payload: inputs)),
