...
abstract class BaseTextInput extends StatefulWidget
  ...
  Map<String, Function> setters() {
    ...
    return {
      'validateOnUserInteraction': (value) => _controller.validateOnUserInteraction = Utils.getBool(value, fallback: _controller.validateOnUserInteraction),
  ...
  Widget buildWidget(BuildContext context) {
    ...
    return InputWrapper(
        ...
        widget: TextFormField(
          key: validatorKey,
          autovalidateMode: widget._controller.validateOnUserInteraction?AutovalidateMode.onUserInteraction:AutovalidateMode.disabled,
          validator: (value) {
