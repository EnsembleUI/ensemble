...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  final List<String> entries = <String>[
    'Sample1: Guess Gender from Name',
    'Sample2: Stock Quotes',
    'Sample3: Web View of news'
  ];
  final List<String> entryPaths = <String>[
    'a0dcfefc-298d-42ab-932a-aab70c87891b',
        ...
        home: Scaffold(
            ...
            body: Container(
              ...
              const Padding(
                  ...
                  child: Text(
                    "Above are just three examples of Server Driven UI. "
