...
Command-line dApp example for `ensemble_walletconnect`.

## Overview

This example demonstrates dApp-side WalletConnect flows using the local `ensemble_walletconnect` package.
...
The example includes `test/dapp_test.dart`.
