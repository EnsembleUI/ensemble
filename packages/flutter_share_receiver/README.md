...
To use this plugin, add `flutter_share_receiver` as a dependency in your `pubspec.yaml` file. For example:
...
```swift
// If you get no such module 'flutter_share_receiver' error.
...
* Error: No such module 'flutter_share_receiver'
