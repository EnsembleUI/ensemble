...
void main() {
  group('cancelNonCompletedUploadTasks', () {
    test('cancels pending and running tasks but leaves completed', () {
      ...
      final running = UploadTask(id: 'run', status: UploadStatus.running);
  ...
  group('backgroundUploadWorkTagsForCancelAll', () {
    test('includes only non-completed background uploads', () {
      final tasks = [
        UploadTask(id: 'done', status: UploadStatus.completed, isBackground: true),
        UploadTask(id: 'bg-run', status: UploadStatus.running, isBackground: true),
        UploadTask(id: 'fg-run', status: UploadStatus.running),
        UploadTask(id: 'bg-wait', isBackground: true),
      ];
