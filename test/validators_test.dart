...
void main () {
  ...
  test('Validate IPs', () {
    ...
    // IPv6
    expect(InputValidator.ipAddress('2001:0db8:85a3:0000:0000:8a2e:0370:7334'), true);
    expect(InputValidator.ipAddress('2345:0425:2CA1:0000:0000:0567:5673:23b5'), true);
    ...
    expect(InputValidator.ipAddress('2345:0425:2CA1:0000:0000:0567:5673'), false);
    expect(InputValidator.ipAddress('2345.0425.2CA1.0000.0000.0567:.5673.23b5'), false);
  });
